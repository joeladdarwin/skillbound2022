...
export class SkillCardComponent implements OnInit {
  ...
  this.userService.currentSkillCard = this.userData?.filter(x =>x.skillId == selectedId)
  ...
  deleteSkill(skills:any){
    ...
    if (confirm(confirmation)== true){
      ...
      this.userService.deleteSkill(skills.skillId).subscribe((deleteMsg:any)=>{
        alert(deleteMsg);
        this.ngOnInit();
   ...
   //updateNotification(updateAlert:any){
